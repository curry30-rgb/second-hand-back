...
public class OrderController {
    ...
    @PostMapping("/date")
    public ResultVo getNumByDate(){
        List<OrderModel> numByDate = orderService.getNumByDate();
        return ResultVo.success(numByDate);
    }

    @PostMapping("/data")
    public ResultVo getData(){
        List<OrderModel> dataByLabel = orderService.getDataByLabel();
        System.out.println(dataByLabel);
        return ResultVo.success(dataByLabel);
    }
